...
public class WorkerDashboard extends javax.swing.JFrame {
    ...
    TablePanel.add(new WorkerProfile(), "WorkerProfile");
    TablePanel.add(new WorkerNotification(),"WorkerNotification");
    TablePanel.add(new WorkerHistory(), "WorkerHistory");

		initializeTablePanel();
                displayUser();
setupButtonActions(btnProfile); 
setupButtonActions(btnNotification); 
setupButtonActions(btnHistory); 
    }
    
    public void displayUser() {
        username_label.setText(AuthenticationController.username);
    }
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(126, 170, 236));
        ...
        btnHistory.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/history.png"))); // NOI18N
        btnHistory.setText("History");
        btnHistory.setToolTipText("");
        btnHistory.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        btnHistory.setHorizontalAlignment(javax.swing.SwingConstants.LEADING);
        btnHistory.setIconTextGap(20);
        btnHistory.setRound(0);
        btnHistory.setShadowColor(new java.awt.Color(255, 255, 255));
...
private void setupButtonActions(Button button) {
    ...
    private void btnNotificationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNotificationActionPerformed
        // TODO add your handling code here:
        TablePanel.setVisible(true);
            cardLayout.show(TablePanel, "WorkerNotification");
    }//GEN-LAST:event_btnNotificationActionPerformed

    private void btnHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHistoryActionPerformed
        // TODO add your handling code here:
        TablePanel.setVisible(true);
            cardLayout.show(TablePanel, "WorkerHistory");
    ...
    private swing.Button btnHistory;
