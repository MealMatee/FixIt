...
initializeUserTable();
	...
	public void initializeUserTable() {
		...
		user_table.setRowMargin(10);
		user_table.setIntercellSpacing(new Dimension(15, 10));
		user_table.setRowHeight(30);

		// Create and set table model
		DefaultTableModel model = new DefaultTableModel(
				new Object[][]{},
				new String[]{"ID", "First Name", "Last Name", "Email", "Phone", "Gender"}
		) {
			@Override
	...
	private void filterWorkers() {
		...
		if (!id.isEmpty()) {
			try {
				worker = AdminController.getUserById(Integer.parseInt(id));
			} catch (NumberFormatException e) {
				JOptionPane.showMessageDialog(this, "Please enter a valid ID", "Error", JOptionPane.ERROR_MESSAGE);
				return;
			}
		} else if (!phone.isEmpty()) {
			worker = AdminController.getUserByPhone(phone);
		} else if (!email.isEmpty()) {
			worker = AdminController.getUserByEmail(email);
		}
	...
	private void displayAllWorkers() {
		...
		List<User> workers = AdminController.getAllUsers();
    ...
    private void initComponents() {
        ...
        user_id_input = new javax.swing.JTextField();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(id_input, javax.swing.GroupLayout.PREFERRED_SIZE, 738, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(phone_input, javax.swing.GroupLayout.PREFERRED_SIZE, 738, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(email_input, javax.swing.GroupLayout.PREFERRED_SIZE, 738, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(113, 113, 113)
        ...
        user_id_input.setText("jTextField1");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(84, 84, 84)
                        .addComponent(user_id_input, javax.swing.GroupLayout.PREFERRED_SIZE, 550, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(42, 42, 42)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(user_id_input, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(35, Short.MAX_VALUE))
        );
    ...
    private void delete_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delete_btnMouseClicked
        // TODO add your handling code here:
		int workerId = Integer.parseInt(user_id_input.getText());
		boolean success = AdminController.deleteUser(workerId);
		if(success){
...
initializeUserTable();
    ...
    private javax.swing.JTextField user_id_input;
